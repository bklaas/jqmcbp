...
my $png_path = "/data/benworld/johnnyquest/2003/graphs";
#my $logo_path = "/data/benworld/johnnyquest/2003/images/jq_graph_logo.png";
my $logo_path = "/data/benworld/johnnyquest/2003/graphs/jq_graph_logo.png";
...
my $region; my $round; my $suppress_angle = 3; 
