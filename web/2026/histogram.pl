...
for my $man_or_chimp ('man', 'chimp') {
    ...
    print STDOUT "Grabbing scores for $man_or_chimp\n";
    my @score_dist;
    my $y_max;
    my @names_unsorted;
    my @scores;
    ...
    #  my $ttfFont = "/usr/share/fonts/ttf-bitstream-vera/VeraBd.ttf";
    my $ttfFont = "/usr/share/fonts/liberation/LiberationSans-Bold.ttf";
    ...
    copy("$png_path/$graph_name", "$webdir/johnnyquest/images/$graph_name") or die $!;
}
