...
my $png_path = "/etc/httpd/htdocs/johnnyquest/2003/graphomatic";
my $logo_path ="/etc/httpd/htdocs/johnnyquest/2003/images/jq_graph_logo.png";

my @data;

my $graphdir = "/etc/httpd/htdocs/johnnyquest/2003/graphomatic";
