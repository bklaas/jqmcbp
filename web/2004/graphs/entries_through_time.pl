...
my @data;
my $graph;
my $logo = "/etc/httpd/htdocs/johnnyquest/2004/images/jq_graph_logo.png";

use Time::Local;
my $start_time = timelocal(00,00,16,14,2,2004);
my $end_time = timelocal(00,00,9,18,2,2004);
...
open(IMG, '>/tmp/2004.png') or die "couldn't open it: $!";
binmode IMG;
print IMG $gd->png;
...
###############################################################
  ...
  my $sql = "select entry_time from player_info order by entry_time";
