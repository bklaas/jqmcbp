...
if ($man_or_chimp eq 'man') {
  ...
  $histogram->set_title_font('/usr/share/fonts/TTF/VeraBd.ttf', 10) or die "couldn't do it: $!";
       $histogram->set_x_label_font('/usr/share/fonts/TTF/VeraBd.ttf', 8);
       $histogram->set_y_label_font('/usr/share/fonts/TTF/VeraBd.ttf', 8);
       $histogram->set_y_axis_font('/usr/share/fonts/TTF/VeraBd.ttf', 8);
       $histogram->set_x_axis_font('/usr/share/fonts/TTF/VeraBd.ttf', 8);
